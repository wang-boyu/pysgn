#!/usr/bin/env python3
#
# PySGN documentation build configuration file.
#
...
project = "PySGN"
copyright = f"2017-{date.today().year}, Wang Boyu"
...
# of the sidebar.
# html_logo = "images/pysgn.png"

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
# html_favicon = "images/pysgn.ico"
